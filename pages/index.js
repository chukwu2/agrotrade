  ...
  return (
    <>
      ...
      <main className="bg-home w-full h-screen flex flex-col justify-end">
        ...
        <div id="gradient" className="elementflex flex flex-col gap-6 h-[40%] justify-center bg-gradient-to-b from-green-600/90 to-green-900 p-3 pb-12 lg:h-[100%] lg:w-[623px]">
